...
export function fakeEvaluation(verdict: "pass" | "fail" | "review", id = "eval_0000000000000001") {
  return {
    id,
    verdict,
    ...
    latency_ms: 42,
    results: [
      { rule: "toxicity", type: "choice", answer: verdict === "fail" ? "toxic" : "safe", probability: 0.9, confidence: 0.9, verdict: verdict === "fail" ? "fail" : "pass" },
      { rule: "pii_detected", type: "noul", answer: false, probability: 0.9, confidence: verdict === "review" ? 0.6 : 0.9, verdict: verdict === "review" ? "review" : "pass" },
    ],
  };
}
